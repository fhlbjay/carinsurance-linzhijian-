...
<head>
    ...
    <script type="text/javascript" src="/static/js/bill/audit.js"></script>
...
<div id="audit_toolbar">
    ...
    <a class="easyui-linkbutton" iconCls="icon-edit" plain=true data-cmd="look">查看详细信息</a>
    <a class="easyui-linkbutton" iconCls="icon-edit" plain=true data-cmd="pass">通过</a>
    <a class="easyui-linkbutton" iconCls="icon-edit" plain=true data-cmd="refuse">拒绝</a>
</div>
<div id="audit_dialog">
            ...
            <div id="aa" class="easyui-accordion" data-options="fit:true,multiple:true,selected:false">
                <div id="accord6" title="批改信息" style="overflow:auto;padding:10px;"
                    ...
                    <table style="margin-top: 15px;">
                        ...
                        <tr>
                            <td>批改期限：</td>
                            <td><input id="auditBiginDate" name="approval.auditbegindate" class="easyui-datebox"/>
                                ~<input id="auditEndDate" name="approval.auditenddate" class="easyui-datebox"/></td>
                        </tr>
                        <tr>
                            <!-- 申请人id -->
                ...
                <div id="accord7" title="审核信息" style="overflow:auto;padding:10px;"
                    ...
                    <table style="margin-top: 15px;">
                        <tr>
                            <td>审核员工：</td>
                            <td><input id="auditorid" name="audit.auditor.id" class="easyui-combobox"
