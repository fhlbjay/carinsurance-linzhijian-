...
<head>
    ...
    <script type="text/javascript" src="/static/js/bill/order.js"></script>
...
<div id="order_toolbar">
    ...
    <input id="idNum" name="idNumber" class="easyui-textbox"
           panelHeight="auto" style=" width: 180px"/>缴费状态:&emsp;
    <select id="pay" name="pay" class="easyui-combobox" panelHeight="auto" style=" width: 100px">
    ...
    <a class="easyui-linkbutton" iconCls="icon-edit" plain=true data-cmd="look">查看申请单明细</a>
</div>
<div id="order_dialog">
            ...
            <div id="aa" class="easyui-accordion" data-options="fit:true,multiple:true,selected:false">
                ...
                <div id="accord1" title="投保人" style="overflow:auto;padding:10px;"
                    ...
                    <table style="margin-top: 15px;">
                        ...
                        <%--该申请单id--%>
                        <input id="orderId" type="hidden" name="id" class="easyui-textbox"/>
                        <tr>
                            <td>名称：</td>
