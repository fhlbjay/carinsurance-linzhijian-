...
<head>
    ...
    <script type="text/javascript" src="/static/js/claimsheet/claimsheet.js"></script>
</head>
<body>
<table id="claimsheet_datagrid"></table>


<div id="claimsheet_toolbar">
    ...
    <a id="changeBtn" class="easyui-linkbutton" iconCls="icon-remove" plain=true data-cmd="changeStatus">状态设置</a>
