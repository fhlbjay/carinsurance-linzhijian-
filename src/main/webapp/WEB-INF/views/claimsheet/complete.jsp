...
<head>
    ...
    <script type="text/javascript" src="/static/js/claimsheet/complete.js"></script>
</head>
<body>
<table id="complete_datagrid"></table>
<div id="complete_toolbar">
