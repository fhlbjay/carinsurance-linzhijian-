...
<head>
    ...
    <script type="text/javascript" src="/static/js/claimsheet/exclusions.js"></script>
</head>
<body>
<table id="exclusions_datagrid"></table>


<div id="exclusions_toolbar">
