...
<div id="order_toolbar">
    ...
    <a id="changeBtn" class="easyui-linkbutton" iconCls="icon-remove" plain=true data-cmd="changeState">财务审核</a>
    <a class="easyui-linkbutton" iconCls="icon-reload" plain=true data-cmd="reld">刷新</a>
    <!-- 查询 -->
    <input id="keywords" name="keywords" class="easyui-textbox" prompt="选择用户"/>
