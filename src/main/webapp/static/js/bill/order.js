$(function () {
    ...
    var onData = {
        look: function edit() {
            ...
            if (selected) {
                ...
                //基本信息
                $("#").textbox("setValue",selected.applicant.id);
                ...
                $.messager.alert("温馨提示", "请选择要修改的暂存单", "info");
                return;
            }
            order_dialog.dialog("setTitle", "暂存单修改").dialog("open");
        },
    ...
    order_datagrid.datagrid({
        ...
        columns: [[
            ...
            {
                field: 'company', title: '承包机构', width: 100, formatter: function (value, row, index) {
                return row.product.company ? row.product.company.name : "";
            }
            },
            {
            ...
            {
                field: 'pay', title: '保费合计', width: 100, formatter: function (value, row, index) {
                return value == 1 ? "未缴" : "已缴";
            }
            }
        ]],
